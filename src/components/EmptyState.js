...
export default function EmptyState({ onCreateProduct, onImportJSON, onImportDB }) {
    return (<div className="flex flex-1 flex-col items-center justify-center px-4 text-center">
      ...
      <div className="flex flex-col items-center gap-3 sm:flex-row">
        ...
        {onImportDB && (<Button onClick={onImportDB} variant="secondary" size="lg" className="gap-2 min-w-[220px]">
